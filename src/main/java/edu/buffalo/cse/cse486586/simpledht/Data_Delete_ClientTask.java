 ...
 */
public class Data_Delete_ClientTask extends AsyncTask<DeleteObject, Void, Void> {

    @Override
    protected Void doInBackground(DeleteObject... deleteObject) {
        try {
            ...
            outputstream.writeObject(deleteObject[0]);
            outputstream.flush();
            socket.close();
